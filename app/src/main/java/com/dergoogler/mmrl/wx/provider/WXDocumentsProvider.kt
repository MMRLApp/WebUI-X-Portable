package com.dergoogler.mmrl.wx.provider
...
class WXDocumentsProvider : DocumentsProvider() {
    ...
    override fun queryRoots(projection: Array<String>?): Cursor {
        ...
        row.add(DocumentsContract.Root.COLUMN_ICON, R.mipmap.launcher)
        return result
    }
    ...
    private fun includeFile(result: MatrixCursor, docId: String?, file: File?) {
        ...
        row.add(DocumentsContract.Document.COLUMN_ICON, R.mipmap.launcher)
    }

    companion object {
        fun isDocumentProviderEnabled(context: Context): Boolean {
            val componentName = ComponentName(context, WXDocumentsProvider::class.java)
